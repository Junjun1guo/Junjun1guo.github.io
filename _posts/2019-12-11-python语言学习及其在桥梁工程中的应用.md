...
date:       2020-12-17
author:     Junjun Guo
header-img: postImg/20201217/headIMG.jpg
catalog: true
---
# Python语言
...
### python语言的发展    
　　Guido von Rossum 1989年开发了python编译器。python语言介于C语言与脚本语言之间，是一种“胶水”语言。python语言的宗旨就是“能用胶水解决的问题，坚决不造轮子”。发展的版本有2.x和3.x，为了使用openseespy建议安装python3.8。[python官网](https://www.python.org/)      

<img src="/raw/master/postImg/20191211/C++之父.png"/>
